...
<div align="center">
  ...
  <table width="280" border="0">
    <tr>
      ...
      <td>{!! Form::select('ciclo_escolars_id', $CiclosEscolares, null, array()) !!}</td>
    </tr>
  </table>
</div>
<p align="center">&nbsp;</p>
<div align="center">
  <table width="896" border="0">
    <tr>
      <td width="350"><div align="left"><strong>MATERIA </strong>{!! Form::select('materias_id', $Materias, null, array()) !!}</div>
      </td>

      <td width="191"><div align="left"><strong>GRUPO </strong>{!! Form::select('grupos_id', $Grupos, null, array()) !!}</div>
      </td>
  ...
  <table width="794" border="0">
    ...
    <tr>
      <td><div align="left"> 
        ...
        {!! link_to('AcuerdoGrupo', $title='Regresar', $attributes = ['class' => 'btn btn-primary']) !!}
      </div></td>
      <td>&nbsp;</td>
      <td><p align="center">&nbsp;</p>
      <p align="center">___________________________</p>
      <div align="right">{!! link_to('AgregarDocumentosM/Calificaciones', $title='Guardar', $attributes = ['class' => 'btn btn-primary']) !!} </div>
      </td>
    </tr>
  </table>
  <hr />
