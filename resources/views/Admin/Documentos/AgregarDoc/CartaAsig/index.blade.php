        ...
        <tbody>
            @foreach($CartaAsignaciones as $CartaAsignacion)
                <tr>
                    ...
                    <td>{!! link_to_route('CalendarioExamenes.edit', $title='Editar', $parameters=$CartaAsignacion->id, $attributes = ['class' => 'btn btn-primary']) !!}
                    </td>

                    <th>{!! Form::open(['route' => ['CalendarioExamenes.destroy', $CartaAsignacion->id], 'method'=>'DELETE']) !!}
